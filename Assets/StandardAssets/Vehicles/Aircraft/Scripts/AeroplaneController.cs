...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_RollEffect = 0.25f;             // The strength of effect for roll input.
        [SerializeField] private float m_PitchEffect = 0.25f;            // The strength of effect for pitch input.
        [SerializeField] private float m_YawEffect = 0.25f;            // The strength of effect for yaw input.
        [SerializeField] private float m_BankedTurnEffect = 0.25f;     // The amount of turn from doing a banked turn.
        [SerializeField] private float m_AerodynamicEffect = 0.02f;   // How much aerodynamics affect the speed of the aeroplane.
        [SerializeField] private float m_AutoTurnPitch = 0.0f;        // How much the aeroplane automatically pitches when in a banked turn.
        [SerializeField] private float m_AutoRollLevel = 0.0f;        // How much the aeroplane tries to level when not rolling.
        [SerializeField] private float m_AutoPitchLevel = 0.0f;       // How much the aeroplane tries to level when not pitching.
        ...
        public float Throttle = 0.8f;                                    // The amount of throttle being used.
